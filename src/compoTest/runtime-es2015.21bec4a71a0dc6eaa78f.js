! function(e) {
    function r(r) {
        for (var n, a, c = r[0], i = r[1], f = r[2], p = 0, s = []; p < c.length; p++) a = c[p], Object.prototype.hasOwnProperty.call(o, a) && o[a] && s.push(o[a][0]), o[a] = 0;
        ...
        if (0 !== t)
            if (t) r.push(t[2]);
                ...
                c.charset = "utf-8", c.timeout = 120, a.nc && c.setAttribute("nonce", a.nc), c.src = function(e) {
                    return a.p + "" + ({}[e] || e) + "-es2015." + {
                        5: "482d9929c5a657b94cf2",
                        6: "a44a528d4baedb63c4cb",
                        7: "444cb69cfcdcf96b1c9b"
                    }[e] + ".js"
                }(e);
                var i = new Error;
                u = function(r) {
